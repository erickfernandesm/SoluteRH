...
const SERVICES = [
  ...
  {
    // CONTEUDO NOVO: a descricao curta veio da Solute; o restante da pagina
    // foi escrito a partir dela e ainda precisa de validacao.
    slug: 'remuneracao-variavel',
    nav: 'Remuneração Variável',
    title: 'Remuneração Variável',
    kicker: 'Incentivo & resultado',
    short: 'Premiação, PLR, PPR, comissão e bônus atrelados a resultado real.',
    blurb:
      'Modelos de remuneração variável desenhados para premiar entrega de verdade, com regra clara, meta possível e cálculo que a empresa consegue sustentar.',
    img: 'planodecargos-e-salarios',
    icon: 'star',
    lead:
      'Remuneração variável mal desenhada é pior do que não ter: paga por resultado que aconteceria de qualquer jeito, premia quem grita mais alto e vira passivo trabalhista quando a regra muda no meio do caminho. Bem desenhada, ela alinha o esforço do time ao que o negócio precisa entregar.',
    pains: [
      'Comissão e bônus definidos no improviso, sem regra escrita.',
      'Premiação que virou direito adquirido e ninguém consegue mais mexer.',
      'Meta que ninguém bate, ou que todo mundo bate sem esforço.',
      'PLR feita na correria de fim de ano, sem acordo formalizado.',
    ],
    delivers: [
      ['Diagnóstico do modelo atual', 'Leitura do que já é pago hoje, com o custo real e o risco trabalhista de cada prática.'],
      ['Escolha do modelo', 'Definição de qual instrumento cabe em cada área: PLR, PPR, comissão, bônus ou premiação.'],
      ['Metas e indicadores', 'Definição de indicadores que a empresa consegue medir e o time consegue influenciar.'],
      ['Regra de cálculo', 'Memória de cálculo, gatilhos, tetos e critérios de elegibilidade, tudo por escrito.'],
      ['Simulação financeira', 'Projeção de custo em diferentes cenários de atingimento, antes de assumir o compromisso.'],
      ['Documentação e comunicação', 'Regulamento, acordo e material para apresentar o modelo ao time sem ruído.'],
    ],
    results: [
      'Esforço do time alinhado à meta do negócio',
      'Custo previsível em cada cenário',
      'Regra clara, sem interpretação dúbia',
      'Menos exposição trabalhista',
    ],
    forWho: 'Empresas que já pagam variável no improviso ou que querem implantar PLR, PPR ou comissionamento com regra.',
  },
  {
    ...
    short: 'Candidatos certos para a vaga e para a cultura, com fit cultural avaliado.',
    blurb:
    ...
    pains: [
      ...
      'Contratação tecnicamente perfeita que não dura seis meses.',
    ],
    delivers: [
      ...
      ['Avaliação de fit cultural', 'Leitura de perfil comportamental e aderência do candidato à cultura, ao cargo e ao gestor.'],
    ...
    results: [
      ...
      'Menos saída nos primeiros meses',
    ],
...
/* --------------------------------------------------------------------------
   ...
   ATENCAO: os textos abaixo estao com LOREM IPSUM de proposito. Só os
   titulos foram validados pela Solute. Substituir short, lead, format,
   duration, forWho e topics por conteudo real antes de publicar.
   Enquanto houver lorem, a pagina fica com noindex (ver _src/pages/treinamentos.js).
   -------------------------------------------------------------------------- */
const TRAININGS = [
  {
